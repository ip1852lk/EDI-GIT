...
(function () {
    ...
    function $(a, b, c, d, e) {
        a = A.createElement(a);
        b && q(a, b);
        e && G(a, {padding: 0, border: U, margin: 0});
        c && G(a, c);
        d && d.appendChild(a);
        return a
    }
    ...
    function ua(a,
            b, c, d) {
        var e = F.lang, a = +a || 0, f = b === -1 ? (a.toString().split(".")[1] || "").length : isNaN(b = P(b)) ? 2 : b, b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "", c = String(z(a = P(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
    ...
    function qb() {
        var a = F.global.useUTC, b = a ? "getUTC" : "get";
    ...
    var s, A = document, H = window, M = Math, w = M.round, ea = M.floor, Ga = M.ceil, u = M.max, D = M.min, P = M.abs, qa = M.cos, wa = M.sin, gb = M.PI, Ba = gb * 2 / 360, xa = navigator.userAgent, zb = H.opera, Aa = /msie/i.test(xa) && !zb, bb = A.documentMode === 8, hb = /AppleWebKit/.test(xa),
            La = /Firefox/.test(xa), Ab = /(Mobile|Android|Windows Phone)/.test(xa), ya = "http://www.w3.org/2000/svg", ca = !!A.createElementNS && !!A.createElementNS(ya, "svg").createSVGRect, Hb = La && parseInt(xa.split("Firefox/")[1], 10) < 4, ha = !ca && !Aa && !!A.createElement("canvas").getContext, Ma, Sa, Bb = {}, ib = 0, ab, F, Za, ia, jb, Na, ma, aa = function () {
        return s
    }, W = [], Ta = 0, Fa = "div", U = "none", Ib = /^[0-9]+$/, Jb = "stroke-width", rb, sb, tb, ub, vb, wb, xb, r = {}, K;
    H.Highcharts ? ma(16, !0) : K = H.Highcharts = {};
    Za = function (a, b, c) {
        if (!t(b) || isNaN(b))
            return"Invalid date";
        var a = m(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b - rb), e, f = d[tb](), g = d[ub](), h = d[vb](), i = d[wb](), j = d[xb](), k = F.lang, l = k.weekdays, d = q({a: l[g].substr(0, 3), A: l[g], d: Da(h), e: h, b: k.shortMonths[i], B: k.months[i], m: Da(i + 1), y: j.toString().substr(2, 2), Y: j, H: Da(f), I: Da(f % 12 || 12), l: f % 12 || 12, M: Da(d[sb]()), p: f < 12 ? "AM" : "PM", P: f < 12 ? "am" : "pm", S: Da(d.getSeconds()), L: Da(w(b % 1E3), 3)}, K.dateFormats);
        for (e in d)
            for (; a.indexOf("%" + e) !== - 1; )
    ...
    Na = {millisecond: 1, second: 1E3, minute: 6E4, hour: 36E5, day: 864E5, week: 6048E5, month: 26784E5, year: 31556952E3};
    ...
    var ra = H.HighchartsAdapter, O = ra || {};
    ra && ra.init.call(ra, jb);
    var cb = O.adapterRun, Kb = O.getScript, Oa = O.inArray, p = O.each, Cb = O.grep, Lb = O.offset, Ua = O.map, E = O.addEvent, Z = O.removeEvent, I = O.fireEvent, Mb = O.washMouseEvent, db = O.animate, Va = O.stop, O = {enabled: !0, x: 0, y: 15, style: {color: "#606060", cursor: "default", fontSize: "11px"}};
    F = {colors: "#7cb5ec,#434348,#90ed7d,#f7a35c,#8085e9,#f15c80,#e4d354,#8085e8,#8d4653,#91e8e1".split(","), symbols: ["circle", "diamond", "square", "triangle", "triangle-down"], lang: {loading: "Loading...", months: "January,February,March,April,May,June,July,August,September,October,November,December".split(","), shortMonths: "Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","), weekdays: "Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday".split(","), decimalPoint: ".", numericSymbols: "k,M,G,T,P,E".split(","),
        ...
        title: {text: "Chart title", align: "center", margin: 15, style: {color: "#333333", fontSize: "18px"}}, subtitle: {text: "", align: "center", style: {color: "#555555"}}, plotOptions: {line: {allowPointSelect: !1, showCheckbox: !1, animation: {duration: 1E3}, events: {}, lineWidth: 2, marker: {lineWidth: 0, radius: 4, lineColor: "#FFFFFF", states: {hover: {enabled: !0, lineWidthPlus: 1, radiusPlus: 2}, select: {fillColor: "#FFFFFF", lineColor: "#000000", lineWidth: 2}}}, point: {events: {}}, dataLabels: y(O, {align: "center", enabled: !1, formatter: function () {
                        return this.y ===
                                null ? "" : ua(this.y, -1)
    ...
    var X = F.plotOptions, ra = X.line;
    qb();
    var Nb = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, Ob = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/, Pb = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, fa = function (a) {
        var b = [], c, d;
        (function (a) {
    ...
    T.prototype = {opacity: 1, textProps: "fontSize,fontWeight,fontFamily,color,lineHeight,width,textDecoration,textShadow,HcTextStroke".split(","), init: function (a, b) {
            ...
            if (f) {
                ...
                f === "radialGradient" && n && !t(g.gradientUnits) && (g = y(g, {cx: n[0] - n[2] / 2 + g.cx * n[2], cy: n[1] - n[2] / 2 + g.cy * n[2], r: g.r * n[2], gradientUnits: "userSpaceOnUse"}));
                for (o in g)
                    o !== "id" && v.push(o, g[o]);
                for (o in j)
                    v.push(j[o]);
            ...
            return a && this.element.namespaceURI === ya ? (this.element.removeAttribute("visibility"), this) : this.attr({visibility: a ? "inherit" : "visible"})
        }, hide: function () {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    f = g.cloneNode(0);
                    h = i * 2 + 1 - 2 * e;
                    N(f, {isShadow: "true", stroke: a.color || "black", "stroke-opacity": j * e, "stroke-width": h, transform: "translate" + k, fill: U});
                    if (c)
    ...
    ba.prototype = {Element: T,
        ...
        destroy: function () {
            ...
            !f && !o && e.indexOf(" ") === -1 ? b.appendChild(A.createTextNode(e)) : (h = /<.*style="([^"]+)".*>/, i = /<.*href="(http[^"]+)".*>/, l && !a.added && this.box.appendChild(b), e = f ? e.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g,
                ...
                p(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        var o = {}, v = A.createElementNS(ya, "tspan"), m;
                        h.test(e) && (m = e.match(h)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), N(v, "style", m));
                        i.test(e) && !d && (N(v, "onclick", 'location.href="' + e.match(i)[1] + '"'), G(v, {cursor: "pointer"}));
                        e = (e.replace(/<(.|\n)*?>/g,
                                "") || " ").replace(/&lt;/g, "<").replace(/&gt;/g, ">");
                        if (e !== " ") {
                            ...
                            N(v, o);
                            b.appendChild(v);
                            !n && f && (!ca && d && G(v, {display: "block"}), N(v, "dy", J(v)));
                            if (l)
                                for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), o = n || e.length > 1 && k.whiteSpace !== "nowrap", p, C, s = k.HcHeight, q = [], t = J(v), Db = 1; o && (e.length || q.length); )
                                    delete a.bBox, p = a.getBBox(), C = p.width, !ca && c.forExport && (C = c.measureSpanWidth(v.firstChild.data, a.styles)), p = C > l, !p || e.length === 1 ?
                                            (e = q, q = [], e.length && (Db++, s && Db * t > s ? (e = ["..."], a.attr("title", a.textStr)) : (v = A.createElementNS(ya, "tspan"), N(v, {dy: t, x: j}), m && N(v, "style", m), b.appendChild(v), C > l && (l = C)))) : (v.removeChild(v.firstChild), q.unshift(e.pop())), e.length && v.appendChild(A.createTextNode(e.join(" ").replace(/- /g, "-")));
                            n++
                        }
                    }
                })
            ...
            var j = this.label(a, b, c, i, null, null, null, null, "button"), k = 0, l, n, o, v, m, p, a = {x1: 0, y1: 0, x2: 0, y2: 1}, e = y({"stroke-width": 1, stroke: "#CCCCCC", fill: {linearGradient: a, stops: [[0,
                            "#FEFEFE"], [1, "#F6F6F6"]]}, r: 2, padding: 5, style: {color: "black"}}, e);
            o = e.style;
            delete e.style;
            ...
            var e = ga(a) ? a.r : e, g = this.createElement("rect"), a = ga(a) ? a : a === s ? {} : {x: a, y: b, width: u(c, 0), height: u(d, 0)};
            if (f !== s)
            ...
            if (h)
                ...
                }, j = a.match(i)[1], a = Bb[j], g = this.image(j).attr({x: b, y: c}), g.isImg = !0, a ? k(g, a) : (g.attr({width: 0, height: 0}), $("img", {onload: function () {
                        k(g,
            ...
            return g
                ...
                return["M", a + c / 2, b, "L", a + c, b + d / 2, a + c / 2, b + d, a, b + d / 2, "Z"]
                    ...
                    e) {
                var f = e.start, c = e.r || c || d, g = e.end - 0.001, d = e.innerR, h = e.open, i = qa(f), j = wa(f), k = qa(g), g = wa(g), e = e.end - f < gb ? 0 : 1;
                return["M", a + c * i, b + c * j, "A", c, c, 0, e, 1, a + c * k, b + c * g, h ? "M" : "L", a + d * k, b + d * g, "A", d, d, 0, e, 0, a + d * i, b + d * j, h ? "" : "Z"]
            }, callout: function (a, b, c, d, e) {
                var f = D(e && e.r || 0, c, d), g = f + 6, h = e && e.anchorX, i = e && e.anchorY, e = w(e.strokeWidth || 0) % 2 / 2;
                a += e;
                b += e;
            ...
            function j() {
                ...
                if (mb) {
                    ...
                    m.isImg || m.attr(q({width: w(o.width), height: w(o.height)}, L));
                    L = null
                }
            }
            function k() {
                var a = o.styles, a = a && a.textAlign, b = u + x * (1 - Q), c;
                c = h ? 0 : lb;
                if (t(Pa) && C && (a === "center" || a === "right"))
                    b += {center: 0.5, right: 1}[a] * (Pa - C.width);
                if (b !== v.x || c !== v.y)
            ...
            var n = this, o = n.g(i), v = n.text("", 0, 0, g).attr({zIndex: 1}), m, C, Q = 0, x = 3, u = 0, Pa, r, A, kb, B = 0, L = {}, lb, mb;
            o.onAdd = function () {
                v.add(o);
                o.attr({text: a || "", x: b, y: c});
                m && t(e) && o.attr({anchorX: e,
                    anchorY: f})
            };
            ...
            return q(o, {css: function (a) {
                    ...
                    return{width: C.width + 2 * x, height: C.height + 2 * x, x: C.x - x, y: C.y - x}
                }, shadow: function (a) {
                    m && m.shadow(a);
                    return o
                }, destroy: function () {
    ...
    Ma = ba;
    q(T.prototype, {htmlCss: function (a) {
            var b = this.element;
        ...
        htmlUpdateTransform: function () {
            ...
            var d = {}, e = Aa ? "-ms-transform" : hb ? "-webkit-transform" : La ? "MozTransform" : zb ? "-o-transform" : "";
            d[e] = d.transform =
                    "rotate(" + a + "deg)";
    ...
    q(ba.prototype, {html: function (a, b, c) {
            ...
            d.attr({text: a, x: w(b), y: w(c)}).css({position: "absolute",
                whiteSpace: "nowrap", fontFamily: this.style.fontFamily, fontSize: this.style.fontSize});
            d.css = d.htmlCss;
            if (f.isSVG)
                d.add = function (a) {
                    ...
                    if (this.parentGroup = a) {
                        if (b = a.div, !b) {
                            ...
                            p(j.reverse(), function (a) {
                                var d;
                                b = a.div = a.div || $(Fa, {className: N(a.element, "class")}, {position: "absolute", left: (a.translateX || 0) + "px", top: (a.translateY || 0) + "px"}, b || c);
                                d = b.style;
    ...
    if (!ca && !ha)
        S = {init: function (a, b) {
                ...
                var a = this.rotation, b = qa(a * Ba), c = wa(a * Ba);
                G(this.element, {filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c,
                        ", M22=", b, ", sizingMethod='auto expand')"].join("") : U})
            }, getSpanCorrection: function (a, b, c, d, e) {
                var f = d ? qa(d * Ba) : 1, g = d ? wa(d * Ba) : 0, h = m(this.elemHeight, this.element.offsetHeight), i;
                this.xCorr = f < 0 && -a;
                this.yCorr = g < 0 && -h;
                i = f * g < 0;
                ...
                return b.css(a)
            }, css: T.prototype.htmlCss, safeRemoveChild: function (a) {
                a.parentNode && Ja(a)
            }, destroy: function () {
            ...
            on: function (a, b) {
                ...
                var d = [], e, f = this.element, g = this.renderer, h, i = f.style, j, k = f.path, l, n, o, v;
                ...
                if (a) {
                    ...
                    for (e = 1; e <= 3; e++) {
                        ...
                        h = $(g.prepVML(j), null, {left: z(i.left) + m(a.offsetX, 1), top: z(i.top) + m(a.offsetY, 1)});
                        if (c)
                            h.cutOff = l + 1;
                ...
                c.style[b] = a
            }}, K.VMLElement = S = da(T, S), S.prototype.ySetter = S.prototype.widthSetter = S.prototype.heightSetter = S.prototype.xSetter, S = {Element: S, isIE8: xa.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
                var e;
                this.alignedObjects = [];
            ...
            isHidden: function () {
                ...
                var e = this, f, g = /^rgba/, h, i, j = U;
                a && a.linearGradient ? i = "gradient" : a && a.radialGradient && (i = "pattern");
                if (i) {
                    var k, l, n = a.linearGradient || a.radialGradient, o, m, J, C, Q, x = "", a = a.stops, s, q = [], u = function () {
                    ...
                    if (c === "fill")
                        if (i === "gradient")
                            ...
                            var j = n.r, t = j * 2, w = j * 2, B = n.cx, L = n.cy, r = b.radialReference, y, j = function () {
                ...
                G(a, {flip: "x", left: z(d.width) - (e ? z(e.top) : 1), top: z(d.height) - (e ? z(e.left) : 1), rotation: -90});
                p(a.childNodes, function (b) {
                    c.invertChild(b, a)
                })
            }, symbols: {arc: function (a, b, c, d, e) {
                    var f = e.start, g = e.end, h = e.r || c ||
                            d, c = e.innerR, d = qa(f), i = wa(f), j = qa(g), k = wa(g);
                    if (g - f === 0)
                        return["x"];
    ...
    Ka.prototype = {addLabel: function () {
            var a =
                    this.axis, b = a.options, c = a.chart, d = a.horiz, e = a.categories, f = a.names, g = this.pos, h = b.labels, i = h.rotation, j = a.tickPositions, d = d && e && !h.step && !h.staggerLines && !h.rotation && c.plotWidth / j.length || !d && (c.margin[3] || c.chartWidth * 0.33), k = g === j[0], l = g === j[j.length - 1], n, f = e ? m(e[g], f[g], g) : g, e = this.label, o = j.info;
            ...
            var c = !0, d = this.axis, e = this.isFirst, f = this.isLast, g = d.horiz ? b.x : b.y, h = d.reversed, i = d.tickPositions, j = this.getLabelSides(), k = j[0], j = j[1], l, n, o, m = this.label.line || 0;
            l = d.labelEdge;
            ...
            var d = this.axis, e = d.options,
                    f = d.chart.renderer, g = d.horiz, h = this.type, i = this.label, j = this.pos, k = e.labels, l = this.gridLine, n = h ? h + "Grid" : "grid", o = h ? h + "Tick" : "tick", v = e[n + "LineWidth"], p = e[n + "LineColor"], C = e[n + "LineDashStyle"], Q = e[o + "Length"], n = e[o + "Width"] || 0, x = e[o + "Color"], q = e[o + "Position"], o = this.mark, u = k.step, t = !0, w = d.tickmarkOffset, r = this.getPosition(g, j, w, b), B = r.x, r = r.y, L = g && B === d.pos + d.len || !g && r === d.pos ? -1 : 1, c = m(c, 1);
            this.isActive = !0;
            if (v) {
                j = d.getPlotLinePath(j + w, v * L, b, !0);
                if (l === s) {
                    l = {stroke: p, "stroke-width": v};
                    if (C)
                        l.dashstyle =
                                C;
                    if (!h)
            ...
            if (n && Q)
                q === "inside" && (Q = -Q), d.opposite && (Q = -Q), h = this.getMarkPath(B, r, Q, n * L, g, f), o ? o.animate({d: h, opacity: c}) : this.mark = f.path(h).attr({stroke: x, "stroke-width": n, opacity: c}).add(d.axisGroup);
            if (i && !isNaN(B))
    ...
    V.prototype = {defaultOptions: {dateTimeLabelFormats: {millisecond: "%H:%M:%S.%L", second: "%H:%M:%S", minute: "%H:%M", hour: "%H:%M", day: "%e. %b", week: "%e. %b", month: "%b '%y", year: "%Y"}, endOnTick: !1, gridLineColor: "#C0C0C0", labels: O, lineColor: "#C0D0E0", lineWidth: 1, minPadding: 0.01,
            ...
            tickWidth: 0, title: {rotation: 270, text: "Values"}, stackLabels: {enabled: !1, formatter: function () {
                ...
                }, style: O.style}}, defaultLeftAxisOptions: {labels: {x: -15, y: null}, title: {rotation: 270}}, defaultRightAxisOptions: {labels: {x: 15, y: null}, title: {rotation: 90}}, defaultBottomAxisOptions: {labels: {x: 0, y: null}, title: {rotation: 0}}, defaultTopAxisOptions: {labels: {x: 0, y: -15}, title: {rotation: 0}}, init: function (a, b) {
            var c = b.isX;
            ...
            var a =
                    this.axis, b = this.value, c = a.categories, d = this.dateTimeLabelFormat, e = F.lang.numericSymbols, f = e && e.length, g, h = a.options.labels.format, a = a.isLog ? b : a.tickInterval;
            if (h)
                g = Ia(h, this);
            else if (c)
                g = b;
            ...
            return n && !d ? null : f.renderer.crispLine(["M", a, i, "L", c, j], b || 1)
                ...
                b, c) {
            var d, e = va(ea(b / a) * a), f = va(Ga(c / a) * a), g = [];
            if (b === c && ka(b))
                return[b];
            for (b = e; b <= f; ) {
                g.push(b);
            ...
            var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked, i = b.options.tickPositioner, j = d.maxPadding,
                    k = d.minPadding, l = d.tickInterval, n = d.minTickInterval, o = d.tickPixelInterval, v, J = b.categories;
            ...
            var a = this.isLog;
            return{min: a ? va(la(this.min)) : this.min, max: a ? va(la(this.max)) : this.max, dataMin: this.dataMin, dataMax: this.dataMax, userMin: this.userMin, userMax: this.userMax}
            ...
            var a = this, b = a.chart, c = b.renderer, d = a.options, e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, j, k, l = 0, n, o = 0, v = d.title, J = d.labels, C = 0, Q = b.axisOffset, b = b.clipOffset, x = [-1, 1, 1, -1][h], q, r = 1, w = m(J.maxStaggerLines, 5), y, A, B, L, z;
            a.hasData = j = a.hasVisibleSeries || t(a.min) && t(a.max) && !!e;
            a.showAxis = k = j || m(d.showEmpty, !0);
            a.staggerLines = a.horiz &&
                    J.staggerLines;
            if (!a.axisGroup)
                a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(), a.labelGroup = c.g("axis-labels").attr({zIndex: J.zIndex || 7}).addClass("highcharts-" + a.coll.toLowerCase() + "-labels").add();
            if (j || a.isLinked) {
            ...
            if (v && v.text && v.enabled !== !1) {
                if (!a.axisTitle)
                    a.axisTitle = c.text(v.text, 0, 0, v.useHTML).attr({zIndex: 7, rotation: v.rotation || 0, align: v.textAlign ||
                                {low: "left", middle: "center", high: "right"}[v.align]}).addClass("highcharts-" + this.coll.toLowerCase() + "-title").css(v.style).add(a.axisGroup), a.axisTitle.isNew = !0;
                if (k)
            ...
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c, g = this.opposite, h = this.offset, i = z(e.style.fontSize || 12), d = {low: f + (a ? 0 : d), middle: f + d / 2, high: f + (a ? d : 0)}[e.align], b = (a ? c + this.height :
            ...
            if (q || h)
                if (a.minorTickInterval && !a.categories && p(a.getMinorTickPositions(), function (b) {
                    ...
                    if (c % 2 === 0 && b < a.max)
                        o[b] || (o[b] = new K.PlotLineOrBand(a)), r = b + C, B = i[c + 1] !== s ? i[c + 1] + C : a.max, o[b].options = {from: g ? la(r) : r, to: g ? la(B) : B, color: J}, o[b].render(), o[b].isActive = !0
                }), !a._addedPlotLB)
                    p((f.plotLines || []).concat(f.plotBands || []), function (b) {
                        a.addPlotBandOrLine(b)
                    }), a._addedPlotLB = !0;
            p([l, n, o], function (a) {
                var b, c, e = [], f = ia ? ia.duration || 500 : 0, g = function () {
                    for (c = e.length; c--; )
                        a[e[c]] &&
            ...
            if (Q)
                b = a.getLinePath(Q), a.axisLine ? a.axisLine.animate({d: b}) : a.axisLine = e.path(b).attr({stroke: f.lineColor, "stroke-width": Q, zIndex: 7}).add(a.axisGroup), a.axisLine[u ? "show" : "hide"]();
            if (k && u)
            ...
            if (this.crosshair)
                if ((t(b) ||
                    ...
                    if (c === null)
                        ...
                        e = {"stroke-width": d.width ||
                                    1, stroke: d.color || "#C0C0C0", zIndex: d.zIndex || 2};
                        if (d.dashStyle)
    ...
    Fb.prototype =
            {init: function (a, b) {
                    ...
                    q(f, {x: g ? (2 * f.x + a) / 3 : a, y: g ? (f.y + b) / 2 : b, anchorX: h ? s : g ? (2 * f.anchorX + c) / 3 : c, anchorY: h ? s : g ? (f.anchorY + d) / 2 : d});
                    e.label.attr(f);
                    if (g)
                    ...
                    var c, d = this.chart, e = d.inverted, f = d.plotTop, g = 0, h = 0, i, a = oa(a);
                    c = a[0].tooltipPos;
                    ...
                    var b = this.points || oa(this), c = b[0].series, d;
                    ...
                    i === !1 ? this.hide() : (this.isHidden && (Va(d), d.attr("opacity", 1).show()), d.attr({text: i}), k = e.borderColor || a.color || h.color || "#606060", d.attr({stroke: k}), this.updatePosition({plotX: f, plotY: g, negative: a.negative, ttBelow: a.ttBelow}), this.isHidden = !1);
    ...
    za.prototype = {init: function (a, b) {
            ...
            var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert,
                    h = b.plotLeft, i = b.plotTop, j = b.plotWidth, k = b.plotHeight, l, n = this.mouseDownX, o = this.mouseDownY, m = c.panKey && a[c.panKey + "Key"];
            d < h ? d = h : d > h + j && (d = h + j);
            e < i ? e = i : e > i + k && (e = i + k);
            ...
            if (this.hasDragged > 10) {
                ...
                this.selectionMarker &&
                        f && (d -= n, this.selectionMarker.attr({width: P(d), x: (d > 0 ? 0 : d) + n}));
            ...
            if (this.selectionMarker) {
                ...
                if (this.hasDragged ||
                    ...
                    p(b.axes, function (b) {
                        if (b.zoomEnabled) {
                            var c = b.horiz, e = a.type === "touchend" ? b.minPixelPadding : 0, o = b.toValue((c ? f : g) + e), c = b.toValue((c ? f + h : g + i) - e);
                            !isNaN(o) && !isNaN(c) && (d[b.coll].push({axis: b, min: D(o, c), max: u(o, c)}), j = !0)
                        }
            ...
            if (b)
                G(b.container, {cursor: b._cursor}), b.cancelClick = this.hasDragged > 10, b.mouseIsDown = this.hasDragged = this.hasPinched = !1, this.pinchDown =
                        []
        ...
        onContainerMouseMove: function (a) {
            ...
            a.cancelBubble = !0;
            b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (I(c.series, "click", q(a, {point: c})), b.hoverPoint && c.firePointEvent("click", a)) : (q(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && I(b, "click", a)))
    ...
    q(K.Pointer.prototype, {pinchTranslate: function (a, b, c, d, e, f) {
            ...
            var i = this.chart, j = a ? "x" : "y", k = a ? "X" : "Y", l = "chart" + k, n = a ? "width" : "height", o = i["plot" + (a ?
                    "Left" : "Top")], m, p, C = h || 1, q = i.inverted, x = i.bounds[a ? "h" : "v"], s = b.length === 1, u = b[0][l], r = c[0][l], t = !s && b[1][l], w = !s && c[1][l], y, c = function () {
            ...
            var b = this, c = b.chart, d = b.pinchDown,
                    e = b.followTouchMove, f = a.touches, g = f.length, h = b.lastValidTouch, i = b.hasZoom, j = b.selectionMarker, k = {}, l = g === 1 && (b.inClass(a.target, "highcharts-tracker") && c.runTrackerClick || c.runChartClick), n = {};
            ...
            if (a.type === "touchstart")
                p(f, function (a, b) {
                    ...
                    if (a.zoomEnabled) {
                        var b = c.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding,
                                e = a.toPixels(m(a.options.min, a.dataMin)), f = a.toPixels(m(a.options.max, a.dataMax)), g = D(e, f), e = u(e, f);
                        b.min = D(a.pos, g - d);
                ...
                if (!j)
                    b.selectionMarker = j = q({destroy: aa}, c.plotBox);
    ...
    if (H.PointerEvent || H.MSPointerEvent) {
        var sa = {}, nb = !!H.PointerEvent, Qb = function () {
            var a, b = [];
            b.item = function (a) {
                return this[a]
            };
            for (a in sa)
                sa.hasOwnProperty(a) && b.push({pageX: sa[a].pageX, pageY: sa[a].pageY, target: sa[a].target});
            return b
        }, ob = function (a, b, c, d) {
            a = a.originalEvent || a;
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && W[na])
                d(a), d = W[na].pointer, d[b]({type: c, target: a.currentTarget, preventDefault: aa, touches: Qb()})
        };
        q(za.prototype, {onContainerPointerDown: function (a) {
        ...
        Y(za.prototype, "init", function (a, b, c) {
            a.call(this, b, c);
            (this.hasZoom || this.followTouchMove) && G(b.container, {"-ms-touch-action": U,
                "touch-action": U})
        });
    ...
    Xa.prototype = {init: function (a, b) {
        ...
        positionCheckboxes: function (a) {
            ...
            if (b)
                c = b.translateY, p(this.allItems, function (e) {
                    var f = e.checkbox, g;
                    f && (g = c + f.y + (a || 0) + 3, G(f, {left: b.translateX + e.checkboxOffset + f.x - 20 + "px", top: g + "px", display: g > c - 6 && g < c + d - 6 ? "" : U}))
                })
            ...
            var b = this.chart, c = b.renderer, d = this.options, e = d.layout === "horizontal", f = this.symbolWidth, g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle, j = this.padding, k = e ? m(d.itemDistance, 20) : 0, l = !d.rtl, n = d.width, o = d.itemMarginBottom || 0, p = this.itemMarginTop, J = this.initialItemX, C = a.legendItem, q = a.series && a.series.drawLegendSymbol ? a.series : a, x = q.options, x = this.createCheckboxForItem &&
                    x && x.showCheckbox, s = d.useHTML;
            if (!C) {
                a.legendGroup = c.g("legend-item").attr({zIndex: 1}).add(this.scrollGroup);
                a.legendItem = C = c.text(d.labelFormat ? Ia(d.labelFormat, a) : d.labelFormatter.call(a), l ? f + g : -g, this.baseline || 0, s).css(y(a.visible ? h : i)).attr({align: l ? "left" : "right", zIndex: 2}).add(a.legendGroup);
                if (!this.baseline)
            ...
            if (l || n) {
                ...
                if (i) {
                    ...
                    a.box = i = c.rect(0, 0, g, h, j.borderRadius, l || 0).attr({stroke: j.borderColor, "stroke-width": l || 0, fill: n || U}).add(d).shadow(j.shadow), i.isNew = !0;
                i[f ? "show" : "hide"]()
            }
            a.legendWidth = g;
            a.legendHeight = h;
        ...
        scroll: function (a, b) {
            ...
            e > d && (e = d);
            if (e > 0)
                b !== s && (ia = m(b, this.chart.animation)), this.nav.attr({translateX: j, translateY: f + this.padding + 7 + this.titleHeight, visibility: "visible"}), this.up.attr({fill: e === 1 ? g : h}).css({cursor: e === 1 ? "default" : "pointer"}), i.attr({text: e + "/" + d}), this.down.attr({x: 18 + this.pager.getBBox().width, fill: e === d ? g : h}).css({cursor: e ===
    ...
    var Ya = K.LegendSymbolMixin = {drawRectangle: function (a, b) {
            ...
            var e = this.chart.renderer, f = this.legendGroup, a = a.baseline -
                    w(e.fontMetrics(a.options.itemStyle.fontSize, this.legendItem).b * 0.3), g;
            if (b.lineWidth) {
    ...
    pa.prototype = {init: function (a,
            ...
            var b = this.axes, c = this.series, d = this.pointer,
                    e = this.legend, f = this.isDirtyLegend, g, h, i = this.hasCartesianSeries, j = this.isDirtyBox, k = c.length, l = k, n = this.renderer, o = n.isHidden(), v = [];
            ...
            if (c && (c.css({width: (f.width || h) + "px"}).align(q({y: g.fontMetrics(f.style.fontSize,
                        c).b - 3}, f), !1, "spacingBox"), !f.floating && !f.verticalAlign))
                b = c.getBBox().height;
            d && (d.css({width: (e.width || h) + "px"}).align(q({y: b + (f.margin - 13) + g.fontMetrics(f.style.fontSize, d).b}, e), !1, "spacingBox"), !e.floating && !e.verticalAlign && (b = Ga(b + d.getBBox().height)));
            ...
            a ? b && (this.renderTo.appendChild(c), Ja(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), G(b, {position: "absolute", top: "-9999px", display: "block"}),
            ...
            c = this.chartWidth;
            d = this.chartHeight;
            this.container = a = $(Fa, {className: "highcharts-container" + (b.className ? " " + b.className : ""), id: e}, q({position: "relative", overflow: "hidden", width: c + "px", height: d + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)"}, b.style), this.renderToClone || a);
            this._cursor = a.style.cursor;
            this.renderer = b.forExport ? new ba(a, c, d, b.style, !0) : new Ma(a, c, d, b.style);
            ha && this.renderer.create(this, a, c, d)
        }, getMargins: function () {
            var a = this.spacing, b, c = this.legend,
                    d = this.margin, e = this.options.legend, f = m(e.margin, 20), g = e.x, h = e.y, i = e.align, j = e.verticalAlign, k = this.titleOffset;
            this.resetMargins();
            b = this.axisOffset;
            if (k && !t(d[0]))
            ...
            var b = this, c = b.options.chart, d = b.renderTo,
                    e = c.width || cb(d, "width"), f = c.height || cb(d, "height"), c = a ? a.target : H, d = function () {
                if (b.container)
            ...
            (ia ? db : G)(d.container, {width: e + "px", height: f + "px"}, ia);
            d.setChartSize(!0);
            ...
            b = Ga(u(d, h[3]) / 2);
            c = Ga(u(d, h[0]) / 2);
            this.clipBox = {x: b, y: c, width: ea(this.plotSizeX - u(d, h[1]) / 2 - b), height: u(0, ea(this.plotSizeY - u(d, h[2]) / 2 - c))};
            ...
            if (k)
                f ? f.animate(x) : this.plotBackground = b.rect(m, p, q, s, 0).attr({fill: k}).add().shadow(a.plotShadow);
            if (l)
                h ? h.animate(x) : this.plotBGImage = b.image(l, m, p, q, s).add();
            r ? r.animate({width: u.width, height: u.height}) : this.clipRect = b.clipRect(u);
            if (n)
                g ? g.animate(g.crisp({x: m,
                    y: p, width: q, height: s})) : this.plotBorder = b.rect(m, p, q, s, 0, -n).attr({stroke: a.plotBorderColor, "stroke-width": n, fill: U, zIndex: 1}).add();
            this.isDirtyBox = !1
            ...
            b.items && p(b.items, function (c) {
                var d = q(b.style, c.style), e = z(d.left) + a.plotLeft, f = z(d.top) + a.plotTop + 12;
                delete d.left;
                delete d.top;
    ...
    R.prototype = {isCartesian: !0, type: "line", pointClass: ja, sorted: !0, requireSorting: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor", r: "radius"}, axisTypes: ["xAxis",
        ...
        updateParallelArrays: function (a, b) {
            ...
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, j = e.chart, k = null, l = e.xAxis, n = l && !!l.categories, o = e.tooltipPoints, v = i.turboThreshold, q = this.xData, C = this.yData, r = (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = m(b, !0);
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData)
                ...
                if (v && h > v) {
                    ...
                    for (c = 0; c < h; c++)
                        if (a[c] !== s && (i = {series: e}, e.pointClass.prototype.applyOptions.apply(i, [a[c]]), e.updateParallelArrays(i, c), n && i.name))
                            l.names[i.x] = i.name;
                Ca(C[0]) && ma(14, !0);
                e.data = [];
                e.options.data = a;
            ...
            e = 0;
            var f, g, h = this.xAxis, i = this.options, j = i.cropThreshold, k = 0, l = this.isCartesian, n, o;
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || ka(i), k = a.threshold, a = 0; a < g; a++) {
                var l = f[a], n = l.x, o = l.y, p = l.low, q = b && e.stacks[(this.negStacks && o < k ? "-" : "") + this.stackKey];
                if (e.isLog && o <= 0)
                    l.y = o = null;
            ...
            a ? (a = b[g], d = b[g + "m"], a || (b[g] = a = c.clipRect(q(e, {width: 0})), b[g + "m"] = d = c.clipRect(-99, f ? -b.plotLeft : -b.plotTop, 99, f ? b.chartWidth : b.chartHeight)), this.group.clip(a), this.markerGroup.clip(d), this.sharedClipKey = g) : ((a = b[g]) && a.animate({width: b.plotSizeX}, d), b[g + "m"] && b[g + "m"].animate({width: b.plotSizeX + 99}, d), this.animate =
                    null)
            ...
            var l = this.pointAttr[""], n, o = this.markerGroup, p = m(d.enabled, this.activePointCount <
                ...
                for (f = b.length; f--; )
                    if (g = b[f], d = ea(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {}, a = p && i.enabled === s || i.enabled, n = c.isInsidePlot(w(d), e, c.inverted), a && e !== s && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = m(i.symbol, this.symbol), j = i.indexOf("url") === 0, k)
                            k[n ? "show" : "hide"](!0).animate(q({x: d - h, y: e - h}, k.symbolName ? {width: 2 * h, height: 2 * h} : {}));
                        else {
                            if (n && (h > 0 || j))
            ...
            var n = b.negativeColor, o = c.lineColor, m = c.fillColor;
            i = b.turboThreshold;
            var s;
            b.marker ?
            ...
            var a = this, b = a.chart, c = /AppleWebKit\/533/.test(xa), d, e, f = a.data || [], g, h, i;
            I(a, "destroy");
            Z(a);
            ...
            var a =
                    this, b = this.options, c = [["graph", b.lineColor || this.color]], d = b.lineWidth, e = b.dashStyle, f = b.linecap !== "square", g = this.getGraphPath(), h = b.negativeColor;
            h && c.push(["graphNeg", h]);
            p(c, function (c, h) {
                var k = c[0], l = a[k];
                if (l)
                    ...
                    l = {stroke: c[1], "stroke-width": d, fill: U, zIndex: 1}, e ? l.dashstyle = e : f && (l["stroke-linecap"] = l["stroke-linejoin"] = "round"), a[k] = a.chart.renderer.path(g).attr(l).add(a.group).shadow(!h && b.shadow)
            })
        }, clipNeg: function () {
            ...
            c && (a.inverted && c.attr({width: a.plotWidth, height: a.plotHeight}), c.animate({translateX: m(d && d.left, a.plotLeft), translateY: m(e && e.top, a.plotTop)}));
            this.translate();
    ...
    q(pa.prototype, {addSeries: function (a, b, c) {
            var d, e = this;
            a && (b = m(b, !0), I(e, "addSeries", {options: a}, function () {
                d = e.initSeries(a);
                e.isDirtyLegend = !0;
                e.linkSeries();
                b && e.redraw(c)
            ...
            new V(this, y(a, {index: this[e].length, isX: b}));
            f[e] = oa(f[e] || {});
            f[e].push(a);
            m(c, !0) && this.redraw(d)
            ...
            if (!d)
                b.loadingDiv = d = $(Fa, {className: "highcharts-loading"}, q(e.style, {zIndex: 10, display: U}), b.container), b.loadingSpan = $("span",
                        null, e.labelStyle, d), E(b, "redraw", f);
            b.loadingSpan.innerHTML = a || c.lang.loading;
            if (!b.loadingShown)
                G(d, {opacity: 0, display: ""}), db(d, {opacity: e.style.opacity}, {duration: e.showDuration || 0}), b.loadingShown = !0;
            f()
    ...
    q(ja.prototype, {update: function (a, b, c) {
            var d = this, e = d.series, f = d.graphic, g, h = e.data, i = e.chart, j = e.options, b = m(b,
                    !0);
    ...
    q(R.prototype, {addPoint: function (a, b, c, d) {
            ...
            var c = this, d = this.chart, e = this.userOptions, f = this.type, g = r[f].prototype, h = ["group", "markerGroup", "dataLabelsGroup"], i;
            p(h, function (a) {
                h[a] = c[a];
                delete c[a]
            });
            a = y(e, {animation: !1, index: this.index,
                pointStart: this.xData[0]}, {data: this.options.data}, a);
            this.remove(!1);
            for (i in g)
    ...
    O = da(R);
    r.line = O;
    X.column = y(ra, {borderColor: "#FFFFFF", borderRadius: 0, groupPadding: 0.2, marker: null, pointPadding: 0.1, minPointLength: 0, cropThreshold: 50, pointRange: null, states: {hover: {brightness: 0.1,
    ...
    O = da(R, {type: "column", pointAttrToOptions: {stroke: "borderColor", fill: "color", r: "borderRadius"}, cropShoulder: 0, trackerGroups: ["group", "dataLabelsGroup"], negStacks: !0, init: function () {
            ...
            var c = D(P(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len), j = c * b.groupPadding, k = (c - 2 * j) / i, l = b.pointWidth, b = t(l) ? (k - l) / 2 : k * b.pointPadding, l = m(l, k - 2 * b);
            return a.columnMetrics =
                    {width: l, offset: b + (j + ((e ? i - (a.columnIndex || 0) : a.columnIndex) || 0) * k - c / 2) * (e ? -1 : 1)}
        }, translate: function () {
            var a = this, b = a.chart, c = a.options, d = a.borderWidth = m(c.borderWidth, a.activePointCount > 0.5 * a.xAxis.len ? 0 : 1), e = a.yAxis, f = a.translatedThreshold = e.getThreshold(c.threshold), g = m(c.minPointLength, 5), c = a.getColumnMetrics(), h = c.width, i = a.barW = Ga(u(h, 1 + 2 * d)), j = a.pointXOffset = c.offset, k = -(d % 2 ? 0.5 : 0), l = d % 2 ? 0.5 : 1;
            b.renderer.isVML && b.inverted && (l += 1);
            R.prototype.translate.apply(a);
            p(a.points, function (c) {
                var d =
                        m(c.yBottom, f), p = D(u(-999 - d, c.plotY), e.len + 999 + d), q = c.plotX + j, s = i, r = D(p, d), x;
                x = u(p, d) - r;
                ...
                p && (r -= 1, x += 1);
                c.shapeType = "rect";
                c.shapeArgs = {x: q, y: r, width: s, height: x}
            })
        }, getSymbol: aa, drawLegendSymbol: Ya.drawRectangle, drawGraph: aa, drawPoints: function () {
            var a = this,
                    b = this.chart, c = a.options, d = b.renderer, e = c.animationLimit || 250, f, g;
            p(a.points, function (h) {
                var i = h.plotY, j = h.graphic;
                if (i !== s && !isNaN(i) && h.y !== null)
                    f = h.shapeArgs, i = t(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g = h.pointAttr[h.selected ? "select" : ""] || a.pointAttr[""], j ? (Va(j), j.attr(i)[b.pointCount < e ? "animate" : "attr"](y(f))) : h.graphic = d[h.shapeType](f).attr(g).attr(i).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius);
                else if (j)
                    h.graphic = j.destroy()
            })
        }, animate: function (a) {
    ...
    r.column = O;
    X.scatter = y(ra, {lineWidth: 0, tooltip: {headerFormat: '<span style="color:{series.color}">●</span> <span style="font-size: 10px;"> {series.name}</span><br/>',
            pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>"}, stickyTracking: !1});
    ra = da(R, {type: "scatter", sorted: !1, requireSorting: !1, noSharedTooltip: !0, trackerGroups: ["markerGroup", "dataLabelsGroup"], takeOrdinalPosition: !1, singularTooltips: !0, drawGraph: function () {
    ...
    R.prototype.drawDataLabels = function () {
        ...
        if (d.enabled || a._hasPointLabels)
            a.dlProcessOptions && a.dlProcessOptions(d),
                    i = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), !a.hasRendered && m(d.defer, !0) && (i.attr({opacity: 0}), E(a, "afterAnimate", function () {
                a.visible && i.show();
                i[b.animation ? "animate" : "attr"]({opacity: 1}, {duration: 200})
            })), g = d, p(e, function (b) {
                var e, l = b.dataLabel, n, o, p = b.connector, r = !0;
    ...
    R.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        if (a = this.visible && (a.series.forceDL || f.isInsidePlot(h, w(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g)))
            d = q({x: g ? f.plotWidth - i : h, y: w(g ? f.plotHeight - h : i), width: 0, height: 0}, d), q(c, {width: j.width, height: j.height}), c.rotation ? b[e ? "attr" : "animate"]({x: d.x + c.x + d.width / 2, y: d.y + c.y + d.height / 2}).attr({align: c.align}) : (b.align(c, null, d), g = b.alignAttr, m(c.overflow,
    ...
    if (r.pie)
        r.pie.prototype.drawDataLabels = function () {
            var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = m(e.connectorPadding, 10), g = m(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, i, j, k = m(e.softConnector, !0), l = e.distance, n = a.center, o = n[2] / 2, q = n[1], s = l > 0, r, t, x, y = [[], []], A, z, G, I, B, L = [0, 0, 0, 0], M = function (a, b) {
                return b.y - a.y
            };
                ...
                for (I = 2; I--; ) {
                    ...
                    if (H) {
                        ...
                        for (B = 0; B < H; B++) {
                            ...
                            r._attr = {visibility: G, align: x[6]};
                            r._pos = {x: A + e.x + ({left: f, right: -f}[x[6]] || 0), y: z + e.y - 10};
                            r.connX = A;
                            r.connY = z;
                ...
                if (Ea(L) === 0 || this.verifyDataLabelOverflow(L))
                    this.placeDataLabels(), s && g && p(this.points, function (b) {
                        ...
                        if ((r = b.dataLabel) && r._pos)
                            G = r._attr.visibility, A = r.connX, z = r.connY, j = k ? ["M", A + (x[6] === "left" ? 5 : -5), z, "C", A, z, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", A + (x[6] === "left" ? 5 : -5), z, "L", x[2], x[3], "L", x[4], x[5]], i ? (i.animate({d: j}), i.attr("visibility",
                                    G)) : b.connector = i = a.chart.renderer.path(j).attr({"stroke-width": g, stroke: e.connectorColor || b.color || "#606060", visibility: G}).add(a.dataLabelsGroup);
                        else if (i)
    ...
    if (r.column)
        r.column.prototype.alignDataLabel = function (a, b, c, d, e) {
            var f = this.chart, g = f.inverted, h = a.dlBox || a.shapeArgs, i = a.below || a.plotY > m(this.translatedThreshold,
                    f.plotSizeY), j = m(c.inside, !!this.options.stacking);
    ...
    q(eb.prototype, {defaultColorAxisOptions: {lineWidth: 0,
            gridLineWidth: 1, tickPixelInterval: 72, startOnTick: !0, endOnTick: !0, offset: 0, marker: {animation: {duration: 50}, color: "gray", width: 0.01}, labels: {overflow: "justify"}, minColor: "#EFEFFF", maxColor: "#003875", tickLength: 5}, init: function (a, b) {
            var c = a.options.legend.layout !== "vertical", d;
            d = y(this.defaultColorAxisOptions, {side: c ? 2 : 1, reversed: !c}, b, {isX: c, opposite: !c, showEmpty: !1, title: null, isColor: !0});
            ...
            var b = this, c = this.chart, d, e = 0, f = this.options;
            this.dataClasses = d = [];
            this.legendItems = [];
            ...
            this.legendColor = {linearGradient: {x1: a[0], y1: a[1], x2: a[2], y2: a[3]},
            ...
            if (b)
                f = this.toPixels(b.value), f < g ? f = g - 2 : f > g + h && (f = g + h + 2), b.plotX = f, b.plotY = this.len - f, V.prototype.drawCrosshair.call(this, a, b), b.plotX = d, b.plotY = e, !c && this.cross && this.cross.attr({fill: this.crosshair.color}).add(this.labelGroup)
        }, getPlotLinePath: function (a, b, c, d, e) {
    ...
    S = {pointAttrToOptions: {stroke: "borderColor", "stroke-width": "borderWidth", fill: "color", dashstyle: "dashStyle"}, pointArrayMap: ["value"], axisTypes: ["xAxis", "yAxis", "colorAxis"], optionalAxis: "colorAxis", trackerGroups: ["group", "markerGroup", "dataLabelsGroup"], getSymbol: aa,
        parallelArrays: ["x", "y", "value"], translateColors: function () {
    ...
    X.map = y(X.scatter, {allAreas: !0, animation: !1, nullColor: "#F8F8F8", borderColor: "silver", borderWidth: 1, marker: null, stickyTracking: !1, dataLabels: {formatter: function () {
    ...
    var Gb = da(ja, {applyOptions: function (a, b) {
            var c = ja.prototype.applyOptions.call(this, a, b), d = this.series, e = d.joinBy;
            if (d.mapData)
            ...
            var a = this, b = +new Date, c = fa(a.color), d = fa(a.pointAttr.hover.fill), e = a.series.options.states.normal.animation, f = e && (e.duration || 500), g;
            if (f && c.rgba.length === 4 && d.rgba.length === 4 && a.state !== "select")
                g = a.pointAttr[""].fill, delete a.pointAttr[""].fill,
    ...
    r.map = da(r.scatter, y(S, {type: "map", pointClass: Gb, supportsDrilldown: !0, getExtremesFromAll: !0,
        useMapGeometry: !0, forceDL: !0, getBox: function (a) {
            var b = Number.MAX_VALUE, c = -b, d = b, e = -b, f = b, g = b, h = this.xAxis, i = this.yAxis, j;
            p(a || [], function (a) {
                if (a.path) {
                    if (typeof a.path === "string")
                        a.path = K.splitPath(a.path);
                    var h = a.path || [], i = h.length, o = !1, p = -b, q = b, r = -b, s = b, t = a.properties;
                    if (!a._foundBox) {
                        for (; i--; )
            ...
            if (j) {
                ...
                if (h && h.options.minRange === void 0)
                    h.minRange = Math.min(5 * g, (this.maxX - this.minX) / 5, h.minRange ||
                            b);
            ...
            if (a)
                for (i =
                        a.length; i--; )
                    typeof a[i] === "number" ? (j[i] = b ? (a[i] - e) * f + c : (a[i] - g) * h + d, b = !b) : j[i] = a[i];
            return j
            ...
            p(a.data, function (d) {
                ...
                if (a.isDirtyData || a.chart.renderer.isVML)
                    d.shapeType = "path",
                            d.shapeArgs = {d: a.translatePath(d.path), "vector-effect": "non-scaling-stroke"}
            });
            a.translateColors()
        }, drawPoints: function () {
            var a = this.xAxis, b = this.yAxis, c = this.group, d = this.chart, e = d.renderer, f = this.baseTrans;
            if (!this.transformGroup)
                this.transformGroup = e.g().attr({scaleX: 1, scaleY: 1}).add(c);
            this.isDirtyData || e.isVML || !f ? (d.hasRendered && this.pointAttrToOptions.fill === "color" && p(this.points, function (a) {
                a.graphic && a.graphic.attr("fill", a.color)
                    ...
                    }), this.baseTrans = {originX: a.min - a.minPixelPadding / a.transA, originY: b.min - b.minPixelPadding / b.transA + (b.reversed ? 0 : b.len / b.transA), transAX: a.transA, transAY: b.transA}) : (c = a.transA / f.transAX, d = b.transA / f.transAY, c > 0.99 && c < 1.01 && d > 0.99 && d < 1.01 ? (b = a = 0, d = c =
                    1) : (a = a.toPixels(f.originX, !0), b = b.toPixels(f.originY, !0)), this.transformGroup.animate({translateX: a, translateY: b, scaleX: c, scaleY: d}));
            ...
            if (this.chart.renderer.isSVG)
                b === !0 && (b = {duration: 1E3}), a ? c.attr({translateX: f + d.len / 2, translateY: g + e.len / 2, scaleX: 0.001, scaleY: 0.001}) : (c.animate({translateX: f, translateY: g, scaleX: 1, scaleY: 1}, b), this.animate = null)
            ...
            if (!a)
                a = Math.min(d.width / b.width, d.height / b.height), c.shapeArgs = {scaleX: a, scaleY: a, translateX: d.x, translateY: d.y}, p(this.points, function (a) {
    ...
    q(pa.prototype,
            {renderMapNavigation: function () {
                    ...
                    if (m(b.enableButtons, b.enabled) && !a.renderer.forExport)
                        for (d in c)
                            if (c.hasOwnProperty(d))
                                f = y(b.buttonOptions, c[d]), e = f.theme, g = e.states, e = a.renderer.button(f.text, 0, 0, h, e, g && g.hover, g && g.select, 0, d === "zoomIn" ? "topbutton" : "bottombutton").attr({width: f.width, height: f.height, title: a.options.lang[d], zIndex: 5}).css(f.style).add(), e.handler = f.onclick, e.align(q(f, {width: e.width,
                                    height: 2 * e.height}), null, f.alignTo)
                    ...
                    var f = this.xAxis[0], g = f.max - f.min, h = m(b, f.min + g / 2), i = g * a, g = this.yAxis[0], j = g.max - g.min, k = m(c, g.min + j / 2);
                    j *= a;
                    h = this.fitToBox({x: h - i * (d ? (d - f.pos) / f.len : 0.5), y: k - j * (e ? (e - g.pos) / g.len : 0.5), width: i, height: j}, {x: f.dataMin,
                        y: g.dataMin, width: f.dataMax - f.dataMin, height: g.dataMax - g.dataMin});
                    if (d)
                        f.fixTo = [d - f.pos, b];
                    if (e)
                        g.fixTo = [e - g.pos, c];
    ...
    q(za.prototype, {onContainerDblClick: function (a) {
    ...
    X.mapline = y(X.map, {lineWidth: 1, fillColor: "none"});
    r.mapline = da(r.map, {type: "mapline", pointAttrToOptions: {stroke: "color", "stroke-width": "lineWidth", fill: "fillColor", dashstyle: "dashStyle"}, drawLegendSymbol: r.line.prototype.drawLegendSymbol});
    X.mappoint = y(X.scatter, {dataLabels: {enabled: !0, formatter: function () {
                return this.point.name
            }, color: "black",
            crop: !1, defer: !1, overflow: !1, style: {HcTextStroke: "3px rgba(255,255,255,0.5)"}}});
    r.mappoint = da(r.scatter, {type: "mappoint", forceDL: !0});
    X.bubble = y(X.scatter, {dataLabels: {formatter: function () {
                return this.point.z
    ...
    var Rb = da(ja, {haloPath: function () {
            return ja.prototype.haloPath.call(this,
                    this.shapeArgs.r + this.series.options.states.hover.halo.size)
        }});
    r.bubble = da(r.scatter, {type: "bubble", pointClass: Rb, pointArrayMap: ["y", "z"], parallelArrays: ["x", "y", "z"], trackerGroups: ["group", "dataLabelsGroup"], bubblePadding: !0, pointAttrToOptions: {stroke: "lineColor", "stroke-width": "lineWidth", fill: "fillColor"}, applyOpacity: function (a) {
            var b = this.options.marker, c = m(b.fillOpacity, 0.5), a = a || b.fillColor || this.color;
            ...
            for (a = b.length; a--; )
                c = b[a], d = e ? e[a] : 0, c.negative = c.z < (this.options.zThreshold || 0), d >= this.minPxSize / 2 ? (c.shapeType = "circle", c.shapeArgs = {x: c.plotX, y: c.plotY, r: d}, c.dlBox = {x: c.plotX - d, y: c.plotY - d, width: 2 * d, height: 2 * d}) : c.shapeArgs = c.plotY = c.dlBox = s
        }, drawLegendSymbol: function (a, b) {
    ...
    V.prototype.beforePadding = function () {
        var a = this, b = this.len, c = this.chart, d = 0, e = b, f = this.isXAxis, g = f ? "xData" : "yData", h = this.min, i = {}, j = M.min(c.plotWidth, c.plotHeight), k = Number.MAX_VALUE, l = -Number.MAX_VALUE, n = this.max - h, o = b / n, q = [];
    ...
    if (r.bubble)
        X.mapbubble = y(X.bubble,
                {animationLimit: 500, tooltip: {pointFormat: "{point.name}: {point.z}"}}), r.mapbubble = da(r.bubble, {pointClass: da(ja, {applyOptions: Gb.prototype.applyOptions}), xyFromShape: !0, type: "mapbubble", pointArrayMap: ["z"], getMapData: r.map.prototype.getMapData, getBox: r.map.prototype.getBox, setData: r.map.prototype.setData});
    K.geojson = function (a, b, c) {
        ...
        p(a.features, function (a) {
            var c = a.geometry,
                    i = c.type, c = c.coordinates, a = a.properties, j;
            e = [];
            b === "map" || b === "mapbubble" ? (i === "Polygon" ? (p(c, f), e.push("Z")) : i === "MultiPolygon" && (p(c, function (a) {
                p(a, f)
            }), e.push("Z")), e.length && (j = {path: e})) : b === "mapline" ? (i === "LineString" ? f(c) : i === "MultiLineString" && p(c, f), e.length && (j = {path: e})) : b === "mappoint" && i === "Point" && (j = {x: c[0], y: -c[1]});
    ...
    q(F.lang, {zoomIn: "Zoom in", zoomOut: "Zoom out"});
    F.mapNavigation = {buttonOptions: {alignTo: "plotBox", align: "left", verticalAlign: "top", x: 0, width: 18, height: 18, style: {fontSize: "15px", fontWeight: "bold", textAlign: "center"}, theme: {"stroke-width": 1}}, buttons: {zoomIn: {onclick: function () {
                    this.mapZoom(0.5)
    ...
    K.Map = function (a, b) {
        ...
        d = a.series;
        a.series = null;
        a = y({chart: {panning: "xy", type: "map"}, xAxis: c, yAxis: y(c, {reversed: !0})}, a, {chart: {inverted: !1, alignTicks: !1, preserveAspectRatio: !0}});
        a.series = d;
        return new pa(a, b)
    };
    F.plotOptions.heatmap = y(F.plotOptions.scatter, {animation: !1, borderWidth: 0, nullColor: "#F8F8F8", dataLabels: {formatter: function () {
                return this.point.value
            }, verticalAlign: "middle",
            crop: !1, overflow: !1, style: {color: "white", fontWeight: "bold", HcTextStroke: "1px rgba(0,0,0,0.5)"}}, marker: null, tooltip: {pointFormat: "{point.x}, {point.y}: {point.value}<br/>"}, states: {normal: {animation: !0}, hover: {brightness: 0.2}}});
    r.heatmap = da(r.scatter, y(S, {type: "heatmap", pointArrayMap: ["y", "value"], hasPointSpecificOptions: !0, supportsDrilldown: !0, getExtremesFromAll: !0, init: function () {
        ...
        }, drawPoints: r.column.prototype.drawPoints, animate: aa, getBox: aa, drawLegendSymbol: Ya.drawRectangle, getExtremes: function () {
            R.prototype.getExtremes.call(this, this.valueData);
            this.valueMin = this.dataMin;
            this.valueMax = this.dataMax;
            R.prototype.getExtremes.call(this)
        }}));
    S = K.TrackerMixin = {drawTrackerPoint: function () {
            ...
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath),
                    e = d.length, f = a.chart, g = f.pointer, h = f.renderer, i = f.options.tooltip.snap, j = a.tracker, k = b.cursor, l = k && {cursor: k}, k = a.singlePoints, n, o = function () {
                if (f.hoverSeries !== a)
                    a.onMouseOver()
            ...
            j ? j.attr({d: d}) : (a.tracker = h.path(d).attr({"stroke-linejoin": "round",
                visibility: a.visible ? "visible" : "hidden", stroke: m, fill: c ? m : U, "stroke-width": b.lineWidth + (c ? 0 : 2 * i), zIndex: 2}).add(a.group), p([a.tracker, a.markerGroup], function (a) {
    ...
    q(Xa.prototype, {setItemEvents: function (a,
                b, c, d, e) {
            var f = this;
    ...
    q(pa.prototype, {showResetZoom: function () {
            ...
            p(b === "xy" ? [1, 0] : [1], function (b) {
                ...
                h.series.length && l > D(k.dataMin, k.min) && i < u(k.dataMax, k.max) && (h.setExtremes(l, i, !1, !1, {trigger: "pan"}), e = !0);
                c[b ? "mouseDownX" : "mouseDownY"] = d
            });
            e && c.redraw(!1);
            G(c.container, {cursor: "move"})
        }});
    q(ja.prototype, {select: function (a, b) {
            ...
            if (!this.hasImportedEvents) {
                ...
                b) {
            var c = this.plotX, d = this.plotY, e = this.series, f = e.options.states, g = X[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], j = i && i.enabled === !1, k = e.stateMarkerGraphic, l = this.marker || {}, n = e.chart, o = e.halo, m, a = a || "";
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (j || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                if (this.graphic)
                    g = g && this.graphic.symbolName && m.r, this.graphic.attr(y(m, g ? {x: c - g,
                        y: d - g, width: 2 * g, height: 2 * g} : {})), k && k.hide();
                else {
                    if (a && i)
                ...
                if ((c = f[a] && f[a].halo) && c.size) {
                    ...
                    o.attr(q({fill: fa(this.color || e.color).setOpacity(c.opacity).get()}, c.attributes))[b ?
    ...
    q(K, {Axis: V, Chart: pa, Color: fa, Point: ja, Tick: Ka, Renderer: Ma, Series: R, SVGElement: T, SVGRenderer: ba, arrayMin: Ra, arrayMax: Ea, charts: W, dateFormat: Za, format: Ia, pathAnim: jb,
        getOptions: function () {
            return F
        }, hasBidiBug: Hb, isTouchDevice: Ab, numberFormat: ua, seriesTypes: r, setOptions: function (a) {
            F = y(!0, F, a);
            qb();
            return F
        }, addEvent: E, removeEvent: Z, createElement: $, discardElement: Ja, css: G, each: p, extend: q, map: Ua, merge: y, pick: m, splat: oa, extendClass: da, pInt: z, wrap: Y, svg: ca, canvas: ha, vml: !ca && !ha, product: "Highmaps", version: "1.0.1"})
})();
