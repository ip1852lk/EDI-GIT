...
<div class="row">
    <?php echo $form->labelEx($model, 'useDefaultColumns'); ?>
    <?php echo $form->dropDownList($model, 'useDefaultColumns', array(0=>'No', 1=>'Yes'));?>
    <div class="tooltip">
        Do you want to add code for default columns? i.e. created_by, created_on, modified_by, modified_on, delete_flag, update_flag
    </div>
    <?php echo $form->error($model, 'useDefaultColumns'); ?>
</div>

<div class="row">
    <?php echo $form->labelEx($model, 'icon'); ?>
    <?php echo $form->textField($model, 'icon', array('size' => 65)); ?>
    <div class="tooltip">
        This icon will be used in views. Please refer to <a href="http://fontawesome.io/icons/">Font Awesome</a> for details.
    </div>
