...
class TbNavbar extends CWidget
{
    ...
    public function init()
    {
        ...
        if ($this->brand !== false) {
            ...
            if ($this->headerOptions['class']) {
                $this->headerOptions['class'] .= ' navbar-header';
            } else {
                $this->headerOptions['class'] = 'navbar-header';
            }
        }
    ...
    public function run()
    {
        ...
        echo '<div class="'.($this->collapse?'collapse ':'').'navbar-collapse" id="' . self::CONTAINER_PREFIX . $this->id . '">';
