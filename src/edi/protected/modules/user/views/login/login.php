    ...
    <div class="body-wrapper">
        <div id="logo" class="row row-centered">
            <div class="col-centered logo-wrapper">
                <?php
                echo CHtml::image($baseUrl.'/img/logo/comparatio-logo.png', 'Logo', array(
        ...
        <div id="dash-subheader" class="row-centered">
            <div class="col-centered">
                <h1 class="" style='color:dimgrey; font-family: "HelveticaNeue-Light", "Helvetica Neue Light", "Helvetica Neue", Helvetica, Arial, "Lucida Grande", sans-serif; '>E D I</h1>
            </div>
        </div>
...
$cs ->registerScript(__CLASS__.'-form', "
    ...
    $('#logo').hide();
    $('#dash-subheader').hide();
    $.backstretch('" . $baseUrl ."/img/background/water-background.jpg');
