...
if (isset($relation)) {
    $columns = array(
        ...
        array(
            'name' => 'profile_search',
            'value' => '($data->user==null || $data->user->profile==null || $data->user->profile->first_name==null ? "" : $data->user->profile->first_name." ".$data->user->profile->last_name)',
    ...
    $columns = array(
        ...
        array(
            ...
            'type' => 'raw',
            'value' => 
                '($data->user==null || $data->user->profile==null || $data->user->profile->first_name==null ? "" : $data->user->profile->first_name." ".$data->user->profile->last_name)'.
