...
class AssignmentController extends RController
{
    ...
    public function accessRules()
    {
        return array(
            array(
                ...
                'actions' => array('view', 'user', 'revoke',),
            ...
            if (isset($_POST['AssignmentForm']) === true) {
                ...
                if ($formModel->validate() === true) {
                    ...
                    Yii::app()->user->setFlash(
                            $this->module->flashSuccessKey, Rights::t('core', 'Permission <span class="label label-warning">:name</span> is assigned successfully.', array(':name' => $item->getNameText()))
                    );
    ...
    public function actionRevoke()
    {
        ...
        if (Yii::app()->request->isPostRequest === true) {
            ...
            Yii::app()->user->setFlash(
                    $this->module->flashSuccessKey, Rights::t('core', 'Permission <span class="label label-warning">:name</span> is revoked successfully.', array(':name' => $item->getNameText()))
            );
