...
Yii::app()->user->setFlash('info', '
    <ul>
        <li>A <span class="label label-warning">Role</span> is group of permissions to perform a variety of <span class="label label-warning">Tasks</span> and <span class="label label-warning">Operations</span>, for example the authenticated user.</li>
        <li><span class="label label-warning">Roles</span> exist at the top of the authorization hierarchy and can therefore inherit from other <span class="label label-warning">Roles</span>, <span class="label label-warning">Tasks</span> and/or <span class="label label-warning">Operations</span>.</li>
...
?>
<p></p>
<div class="role-grid-status-msg">
    <?php
        ...
        array(
            ...
            'buttons' => array(
                'delete' => array(
                    ...
                    'click' => 'function(){ 
                        var th = this;
                        var afterDelete = function(link,success,data){ $(".role-grid-status-msg").html(data); };
                        bootbox.dialog({
