...
// Title
$this->title = Yii::t('app', 'Customer  Edi');
// Breadcrumbs
...
$this->menu = array_merge($this->menu, array(
    array(
        ...
        'url' => '#',
        'encodeLabel' => false,
        'htmlOptions' => array('id' => 'customer--edi-create-save-btn', 'class' => 'navbar-btn btn-sm',),
    ),
));
...
// UIs
echo $this->renderPartial('//customer_EDI/_form', array(
    'model' => $model, 
...
// Save Control
$cs->registerScript(__CLASS__ . 'customer__edi_form_save', '
    $("#customer--edi-create-save-btn").click(function(){
        $("#customer--edi-form-save-btn").trigger("click")
    });
');
