...
// Title
$this->title = Yii::t('app', 'Customer  Edi').' <span class="text-warning">'.$model->CU1_ID.'</span>';
// Breadcrumbs
$this->breadcrumbs = array(
    Yii::t('app', Yii::app()->params['workspaceLabel']) => array(Yii::app()->params['workspaceUrl']),
    Yii::t('app', 'Customer  Edis') => array('index'),
    $model->CU1_ID => array('view', 'id' => $model->CU1_ID),
    Yii::t('app', 'Update'),
);
// Menus
...
$this->menu = array_merge($this->menu, array(
    array(
        ...
        'url' => '#',
        'encodeLabel' => false,
        'htmlOptions' => array('id' => 'customer--edi-update-save-btn', 'class' => 'navbar-btn btn-sm',),
    ),
));
...
$tableLogList = 'window.getDependencyGrid(
    "'.$this->createUrl('/tableLog/dependency', array(
        'dependency' => '/customer_EDI/update',
        'dependencyTabIndex' => 1,
        'dependencyTabDropdownIndex' => 0,
        'parentPk' => 'Customer_EDI',
        'parentId' => $model->CU1_ID,
    )).'",
    "customer--edi-table-log-tab",
    "'.Yii::t('app', 'Loading...').'",
...
if ($this->isMobile) {
    $this->widget('booster.widgets.TbTabs', array(
        'type' => 'tabs',
        'tabMenuHtmlOptions' => array('id' => 'customer--edi_form_tab_menu'),
        'tabs' => array(
            array(
                'active' => isset($tabIndex) && $tabIndex==0 ? true : false,
                'id' => 'customer--edi-form-tab',
                'label' => Yii::t('app', 'Customer_EDI'),
                'content' => $this->renderPartial('//customer_EDI/_form', array(
                    'model' => $model,
    ...
    <div id="customer--edi-form-content" class="row">
        <div class="col-sm-12 col-md-5">
            <?php
            $this->renderPartial('//customer_EDI/_form', array(
                'model' => $model,
                'dependency' => (isset($dependency)?$dependency:null),
                'dependencyTabIndex' => (isset($dependencyTabIndex)?$dependencyTabIndex:null),
                'dependencyTabDropdownIndex' => (isset($dependencyTabDropdownIndex)?$dependencyTabDropdownIndex:null),
        ...
        <div id="customer--edi-dependency-content" class="col-sm-12 col-md-7">
            <?php
            $this->widget('booster.widgets.TbTabs', array(
                'type' => 'tabs',
                'tabMenuHtmlOptions' => array('id' => 'customer--edi_form_tab_menu', 'class' => 'dependency-dropdown'),
                'tabs' => array(
                    array(
                        'active' => isset($tabIndex) && $tabIndex==1 ? true : false,
                        'label' => Yii::t('app', 'Dependency Lists'),
...
if ($tabIndex == 1 && $tabDropdownIndex == 0) 
    $cs->registerScript(__CLASS__ . 'customer__edi_table_log_control', $tableLogList);
// Tab Events
$cs->registerScript(__CLASS__ . 'customer__edi_dependency_control', '
    $("#customer--edi-table-log-tab-btn").click(function(){'.$tableLogList.'});
');
// Save Control
$cs->registerScript(__CLASS__ . 'customer__edi_form_save', '
    $("#customer--edi-update-save-btn").click(function(){
