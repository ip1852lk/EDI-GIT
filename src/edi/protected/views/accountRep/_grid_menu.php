...
<div class="row">
                    ...
                    $this->widget('booster.widgets.TbButtonGroup', array(
                        ...
                        'buttons' => array(
                            array(
                                ...
                                'items' => array(
                                    ...
                                    array(
                                        ...
                                        'linkOptions' => array('class' => 'account-rep-export-btn-'.$dependencyTabDropdownIndex),
                            ...
                            array(
                                ...
                                'label' => Yii::t('app', 'Export'),
                                'url' => '#',
                                'htmlOptions' => array('class' => 'account-rep-export-btn-'.$dependencyTabDropdownIndex.' visible-md visible-lg last-child'),
                                'visible' => $accountRepExport,
                            ),
                        ),
                    ));
                ...
                $this->widget('booster.widgets.TbButtonGroup', array(
                    ...
                    'buttons' => array(
                        array(
                            ...
                            'htmlOptions' => array(
                                'class' => 'first-child',
                                'id' => 'account-rep-relation-select-btn-'.$relationIndex,
                            ),
                        ),
                        array(
                            'buttonType' => TbButton::BUTTON_BUTTON,
                            ...
                            'htmlOptions' => array(
                                'class' => 'last-child',
                                'id' => 'account-rep-relation-close-btn-'.$relationIndex,
                            ),
                        ),
                    ),
                ));
    ...
    <h4 class="content-header"><?php echo Yii::t('app', 'Account Representatives'); ?></h4>
</div>
...
if (isset($dependency)) {
    if ($accountRepExport) {
        $cs->registerScript(__CLASS__ . 'account_rep_export', "
            $('.account-rep-export-btn-".$dependencyTabDropdownIndex."').click(function(event) {
                $.fn.yiiGridView.update('account-rep-grid-".$dependencyTabDropdownIndex."', {
