...
$this->menu = array_merge($this->menu, array(
    array(
        ...
        'url' => '#',
        'encodeLabel' => false,
        'htmlOptions' => array('id' => 'supplier-create-save-btn', 'class' => 'navbar-btn btn-sm',),
    ),
));
...
// UIs
echo $this->renderPartial('//supplier/_form', array(
    'model' => $model, 
...
$cs->registerScript(__CLASS__ . 'supplier_form_save', '
    $("#supplier-create-save-btn").click(function(){
