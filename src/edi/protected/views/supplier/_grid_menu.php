...
<div class="row">
                    ...
                    $this->widget('booster.widgets.TbButtonGroup', array(
                        ...
                        'buttons' => array(
                            array(
                                ...
                                'items' => array(
                                    ...
                                    array(
                                        ...
                                        'linkOptions' => array('class' => 'supplier-export-btn-'.$dependencyTabDropdownIndex),
                            ...
                            array(
                                ...
                                'label' => Yii::t('app', 'Export'),
                                'url' => '#',
                                'htmlOptions' => array('class' => 'supplier-export-btn-'.$dependencyTabDropdownIndex.' visible-md visible-lg last-child'),
                                'visible' => $supplierExport,
                            ),
                        ),
                    ));
                ...
                $this->widget('booster.widgets.TbButtonGroup', array(
                    ...
                    'buttons' => array(
                        array(
                            ...
                            'htmlOptions' => array(
                                'class' => 'first-child',
                                'id' => 'supplier-relation-select-btn-'.$relationIndex,
                            ),
                        ),
                        array(
                            'buttonType' => TbButton::BUTTON_BUTTON,
    ...
    <h4 class="content-header"><?php echo Yii::t('app', 'Suppliers'); ?></h4>
</div>
...
if (isset($dependency)) {
    if ($supplierExport) {
        $cs->registerScript(__CLASS__ . 'supplier_export', "
            $('.supplier-export-btn-".$dependencyTabDropdownIndex."').click(function(event) {
                $.fn.yiiGridView.update('supplier-grid-".$dependencyTabDropdownIndex."', {
