...
$this->menu = array_merge($this->menu, array(
    array(
        ...
        'url' => '#',
        'encodeLabel' => false,
        'htmlOptions' => array('id' => 'bin-type-create-save-btn', 'class' => 'navbar-btn btn-sm',),
    ),
));
...
// UIs
echo $this->renderPartial('//binType/_form', array(
    'model' => $model, 
...
$cs->registerScript(__CLASS__ . 'bin_type_form_save', '
    $("#bin-type-create-save-btn").click(function(){
