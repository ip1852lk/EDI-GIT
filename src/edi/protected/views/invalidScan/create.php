...
// Title
$this->title = Yii::t('app', 'Invalid Scan');
// Breadcrumbs
...
$this->menu = array_merge($this->menu, array(
    array(
        ...
        'url' => '#',
        'encodeLabel' => false,
        'htmlOptions' => array('id' => 'invalid-scan-create-save-btn', 'class' => 'navbar-btn btn-sm',),
    ),
));
...
// UIs
echo $this->renderPartial('//invalidScan/_form', array(
    'model' => $model, 
...
$cs->registerScript(__CLASS__ . 'invalid_scan_form_save', '
    $("#invalid-scan-create-save-btn").click(function(){
