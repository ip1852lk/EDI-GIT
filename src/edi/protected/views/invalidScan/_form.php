...
$this->beginWidget('booster.widgets.TbPanel', array(
    'context' => 'info',
    'title' => $model->isNewRecord ? Yii::t('app', 'Invalid Scan') : $model->id,
    'headerIcon' => 'fa fa-barcode fa-lg',
));
$form = $this->beginWidget('booster.widgets.TbActiveForm', array(
    'id' => 'invalid-scan-form',
    'method' => 'post',
    'type' => 'horizontal',
    ...
    if (!$model->isNewRecord && $invalidScanAdmin) {
    ?>
    ...
    $this->widget('booster.widgets.TbButton', array(
        ...
        'htmlOptions' => array('id' => 'invalid-scan-form-save-btn', 'class' => 'btn-sm', 'style' => 'display: none;',),
    ));
    echo '</div>';
$this->endWidget();
$this->endWidget();
...
//$cs->registerScript(__CLASS__ . 'invalid_scan_relation', '
//    // Relations in InvalidScan: Customer
//    $("#invalid-scan-form").on("click", "#customer-select-btn", function() {
...
//                        value = column.split("==");
//                        if (value[0] == "id") 
//                            $("#InvalidScan_cu1_id").val(value[1]);
//                        if (value[0] == "cu1_name") 
