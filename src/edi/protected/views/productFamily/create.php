...
// Title
$this->title = Yii::t('app', 'Product Family');
// Breadcrumbs
...
$this->menu = array_merge($this->menu, array(
    array(
        ...
        'url' => '#',
        'encodeLabel' => false,
        'htmlOptions' => array('id' => 'product-family-create-save-btn', 'class' => 'navbar-btn btn-sm',),
    ),
));
...
// UIs
echo $this->renderPartial('//productFamily/_form', array(
    'model' => $model, 
...
$cs->registerScript(__CLASS__ . 'product_family_form_save', '
    $("#product-family-create-save-btn").click(function(){
