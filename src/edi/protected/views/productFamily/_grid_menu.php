...
<div class="row">
                    ...
                    $this->widget('booster.widgets.TbButtonGroup', array(
                        ...
                        'buttons' => array(
                            array(
                                ...
                                'items' => array(
                                    ...
                                    array(
                                        ...
                                        'linkOptions' => array('class' => 'product-family-export-btn-'.$dependencyTabDropdownIndex),
                            ...
                            array(
                                ...
                                'label' => Yii::t('app', 'Export'),
                                'url' => '#',
                                'htmlOptions' => array('class' => 'product-family-export-btn-'.$dependencyTabDropdownIndex.' visible-md visible-lg last-child'),
                                'visible' => $productFamilyExport,
                            ),
                        ),
                    ));
                ...
                $this->widget('booster.widgets.TbButtonGroup', array(
                    ...
                    'buttons' => array(
                        array(
                            ...
                            'htmlOptions' => array(
                                'class' => 'first-child',
                                'id' => 'product-family-relation-select-btn-'.$relationIndex,
                            ),
                        ),
                        array(
                            'buttonType' => TbButton::BUTTON_BUTTON,
                            ...
                            'htmlOptions' => array(
                                'class' => 'last-child',
                                'id' => 'product-family-relation-close-btn-'.$relationIndex,
                            ),
                        ),
                    ),
                ));
    ...
    <h4 class="content-header"><?php echo Yii::t('app', 'Product Families'); ?></h4>
</div>
...
if (isset($dependency)) {
    if ($productFamilyExport) {
        $cs->registerScript(__CLASS__ . 'product_family_export', "
            $('.product-family-export-btn-".$dependencyTabDropdownIndex."').click(function(event) {
                $.fn.yiiGridView.update('product-family-grid-".$dependencyTabDropdownIndex."', {
