...
?>
<div class="rack-search-container" style="display:none">
    <?php
    ...
    $form = $this->beginWidget('booster.widgets.TbActiveForm', array(
        ...
        'htmlOptions' => array('class' => 'rack-search-form'),
    ));
        ...
        echo $form->textFieldGroup($model, 'pl1_search', array(
            ...
            'prepend' => '<i class="fa fa-code-fork"></i>',
        ...
        if ($rackAdmin) {
            echo $form->textFieldGroup($model, 'mprofile_search', array(
                'maxlength' => 30,
                'labelOptions' => array('class' => 'col-sm-2 col-md-2', 'for' => 'Rack_mprofile_search_2'),
                'wrapperHtmlOptions' => array('class' => 'col-sm-5 col-md-4'),
                'widgetOptions' => array( 
                    'htmlOptions' => array('id' => 'Rack_mprofile_search_2'),
                ),
                'prepend' => '<i class="fa fa-user"></i>',
                'prependOptions' => array('inputGroupOptions' => array('class' => 'input-group-sm')),
            ));
            echo $form->datePickerGroup($model, 'modified_on', array(
                'labelOptions' => array('class' => 'col-sm-2 col-md-2', 'for' => 'Rack_modified_on_2'),
                'wrapperHtmlOptions' => array('class' => 'col-sm-5 col-md-4'),
                'widgetOptions' => array(
                    'options' => array('language' => Yii::app()->language), 
                    'htmlOptions' => array('id' => 'Rack_modified_on_2'),
                ),
        ...
        <div class="form-actions btn-toolbar">
            ...
            $this->widget('booster.widgets.TbButton', array(
                ...
                'htmlOptions' => array('class' => 'rack-search-close-btn btn-sm'),
            ));
            ?>
        </div>
    <?php
