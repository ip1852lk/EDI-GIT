...
$this->menu = array_merge($this->menu, array(
    array(
        ...
        'url' => '#',
        'encodeLabel' => false,
        'htmlOptions' => array('id' => 'rack-create-save-btn', 'class' => 'navbar-btn btn-sm',),
    ),
));
...
// UIs
echo $this->renderPartial('//rack/_form', array(
    'model' => $model,
    'plant' => $plant,
    'customer' => $customer,
...
$cs->registerScript(__CLASS__ . 'rack_form_save', '
    $("#rack-create-save-btn").click(function(){
