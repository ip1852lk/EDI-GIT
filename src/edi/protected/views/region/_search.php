...
?>
<div class="region-search-container" style="display:none">
    <?php
    ...
    $form = $this->beginWidget('booster.widgets.TbActiveForm', array(
        ...
        'htmlOptions' => array('class' => 'region-search-form'),
    ));
        ...
        if ($regionAdmin) {
            echo $form->textFieldGroup($model, 'mprofile_search', array(
                'maxlength' => 30,
                'labelOptions' => array('class' => 'col-sm-2 col-md-2', 'for' => 'Region_mprofile_search_2'),
                'wrapperHtmlOptions' => array('class' => 'col-sm-5 col-md-4'),
                'widgetOptions' => array( 
                    'htmlOptions' => array('id' => 'Region_mprofile_search_2'),
                ),
                'prepend' => '<i class="fa fa-user"></i>',
                'prependOptions' => array('inputGroupOptions' => array('class' => 'input-group-sm')),
            ));
            echo $form->datePickerGroup($model, 'modified_on', array(
                'labelOptions' => array('class' => 'col-sm-2 col-md-2', 'for' => 'Region_modified_on_2'),
                'wrapperHtmlOptions' => array('class' => 'col-sm-5 col-md-4'),
                'widgetOptions' => array(
                    'options' => array('language' => Yii::app()->language), 
                    'htmlOptions' => array('id' => 'Region_modified_on_2'),
                ),
        ...
        <div class="form-actions btn-toolbar">
            ...
            $this->widget('booster.widgets.TbButton', array(
                ...
                'htmlOptions' => array('class' => 'region-search-close-btn btn-sm'),
            ));
            ?>
        </div>
    <?php
