...
$this->menu = array_merge($this->menu, array(
    array(
        ...
        'url' => '#',
        'encodeLabel' => false,
        'htmlOptions' => array('id' => 'master-data-create-save-btn', 'class' => 'navbar-btn btn-sm',),
    ),
));
...
// UIs
echo $this->renderPartial('//masterData/_form', array(
    'model' => $model,
...
$cs->registerScript(__CLASS__ . 'master_data_form_save', '
    $("#master-data-create-save-btn").click(function(){
