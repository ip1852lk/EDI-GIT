...
<div class="row">
                    ...
                    $this->widget('booster.widgets.TbButtonGroup', array(
                        ...
                        'buttons' => array(
                            array(
                                ...
                                'items' => array(
                                    ...
                                    array(
                                        ...
                                        'linkOptions' => array('class' => 'vendor-export-btn-'.$dependencyTabDropdownIndex),
                            ...
                            array(
                                ...
                                'label' => Yii::t('app', 'Export'),
                                'url' => '#',
                                'htmlOptions' => array('class' => 'vendor-export-btn-'.$dependencyTabDropdownIndex.' visible-md visible-lg last-child'),
                                'visible' => $vendorExport,
                            ),
                        ),
                    ));
                ...
                $this->widget('booster.widgets.TbButtonGroup', array(
                    ...
                    'buttons' => array(
                        array(
                            ...
                            'htmlOptions' => array(
                                'class' => 'first-child',
                                'id' => 'vendor-relation-select-btn-'.$relationIndex,
                            ),
                        ),
                        array(
                            'buttonType' => TbButton::BUTTON_BUTTON,
                            ...
                            'htmlOptions' => array(
                                'class' => 'last-child',
                                'id' => 'vendor-relation-close-btn-'.$relationIndex,
                            ),
                        ),
                    ),
                ));
    ...
    <h4 class="content-header"><?php echo Yii::t('app', 'Vendors'); ?></h4>
</div>
...
if (isset($dependency)) {
    if ($vendorExport) {
        $cs->registerScript(__CLASS__ . 'vendor_export', "
            $('.vendor-export-btn-".$dependencyTabDropdownIndex."').click(function(event) {
                $.fn.yiiGridView.update('vendor-grid-".$dependencyTabDropdownIndex."', {
